	...
	<table id="factura_head">
		<tr>
			<td class="logo_factura">
				<div>
					<img src="img/LOGO_eglos_200.png">
				</div>
			</td>
			<td class="info_empresa">
				<div>
					<span class="h2">SISTEMA VENTAS EGLOS</span>
					<p>Calle 104, 36, Urb. Entrenaranjos</p>
					<p>Ribarroja del Túria 46190 (Valencia)</p>
					<p>Teléfono: +(34) 630628728</p>
					<p>Email: eglos@eglos.es</p>
				</div>
			</td>
