					...
					<?php
						$sql_registros = "SELECT count(*) as total_registros 
									   FROM (
					           				...
					           				WHERE c.estatus != 0
						        				  AND LOWER(CONCAT(c.idcliente, c.nit, c.nombre, c.telefono, c.direccion, u.usuario )) LIKE '%$busqueda%') A";
						...
						$sql = "SELECT c.idcliente, c.nit, c.nombre, c.telefono, c.direccion, c.usuario_id, u.usuario 
						        ...
						        INNER JOIN usuario u 
						           ON c.usuario_id = u.idusuario
						        WHERE c.estatus != 0
		        				     AND LOWER(CONCAT(c.idcliente, c.nit, c.nombre, c.telefono, c.direccion, u.usuario )) LIKE '%$busqueda%'
